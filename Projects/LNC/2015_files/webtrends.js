...
// Created: 12/11/2009 1:35:43 PM
//updated tag for FPC - CN - 4/3/2011

function WebTrends(){
	var that=this;
	// begin: user modifiable
	this.dcsid=dcsidGlobal;
	this.domain="wt.research.gov";
	this.timezone=-5;
	this.fpcdom=".research.gov";
	this.onsitedoms=(function(){return(window.RegExp?new RegExp("research.gov","i"):"");})();
	//this.onsitedoms="www.research.gov, research.gov";
...
//added to enable persistent cookie
