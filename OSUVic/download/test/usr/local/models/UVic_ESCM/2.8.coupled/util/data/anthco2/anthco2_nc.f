...
!=======================================================================
      ...
      name = "anthco2"
      long_name = "Anthropogenic CO2"
      stand_name = "Anthropogenic_CO2"
      vmax = 0.06
      vmin = -0.006
      units = "mol m-3"
      missing_value = -999.
...
!=======================================================================
      ...
      call openfile (trim(path)//'AnthCO2/AnthCO2.nc', iou)
      ...
      do i=1,id
        do j=1,jd
          do k=1,kd
            call getvara ('AnthCO2', iou, 1, (/j,i,k/)
