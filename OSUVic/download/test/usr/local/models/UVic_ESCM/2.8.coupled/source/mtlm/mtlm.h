...
! LONGMIN,LONGMAX = Longitudinal limits of the area (degrees).
      ...
      real LAT, LATMIN, LATMAX, LONG, LONGMIN, LONGMAX

      common /land_r/ LAT(POINTS),LATMIN, LATMAX
...
! NEW_LAND = .T. if land index needs to be recalculated

      logical INT_VEG, VEG_EQUIL, NEW_LAND

      common /land_l/ INT_VEG, VEG_EQUIL, NEW_LAND
...
! ta_FRAC       = time averaged FRAC
      ...
      real ta_RESP_S, ta_GPP, ta_NPP, ta_HT, ta_LAI, ta_C_VEG
      real ta_LYING_SNOW, ta_SURF_ROFF, ta_FRAC
...
! tai_ET         = time averaged integral ET
      ...
      real tai_CS, tai_RESP_S, tai_CV, tai_NPP, tai_GPP, tai_HT, tai_LAI
      real tai_LYING_SNOW, tai_TSOIL, tai_TSTAR, tai_M, tai_ET

      common /land_r/ tai_CS, tai_RESP_S, tai_CV, tai_NPP, tai_GPP
      common /land_r/ tai_HT, tai_LAI, tai_LYING_SNOW, tai_TSOIL
      common /land_r/ tai_TSTAR, tai_M, tai_ET
# endif
#endif
