...
!-----------------------------------------------------------------------
      ...
      integer          iextint, itrajint, iexconvint, icmixint
      common /switc_i/ iextint, itrajint, iexconvint, icmixint
      logical          extts,   trajts,   exconvts,   cmixts
      common /switc_l/ extts,   trajts,   exconvts,   cmixts
      real             extint,  trajint,  exconvint,  cmixint
      common /switc_r/ extint,  trajint,  exconvint,  cmixint

      integer          ivmsfint, igyreint, ityzint, isnapint, ifctint
      common /switc_i/ ivmsfint, igyreint, ityzint, isnapint, ifctint
      logical          vmsfts,   gyrets,   tyzts,   snapts,   fctts
      common /switc_l/ vmsfts,   gyrets,   tyzts,   snapts,   fctts
      real             vmsfint,  gyreint,  tyzint,  snapint,  fctint
      common /switc_r/ vmsfint,  gyreint,  tyzint,  snapint,  fctint
