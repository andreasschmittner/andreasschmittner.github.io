...
!=======================================================================
     ...
     &, 'latitude of the t grid', 'latitude', 'degrees_north')
      ...
      call defvar ('sss', iou, 3, (/id_xt,id_yt,id_time/)
     &, vmin, vmax,' ', 'F', 'sea surface salinity'
     &, 'sea_surface_salinity', trim(units))
      call enddef (iou)
      call putvara ('xt', iou, imt, (/1/), (/imt/), xt, 1., 0.)
      call putvara ('yt', iou, jmt, (/1/), (/jmt/), yt, 1., 0.)
      do n=1,12
        call putvars ('time', iou, n, daymon(n)/365., 1., 0.)
        call putvaramsk ('sss', iou, imt*jmt, (/1,1,n/)
     &,   (/imt,jmt,1/), var(:,:,n), vmask(:,:,1), 1., 0.)
      enddo
      call closefile (iou)
